...
class punchin_screen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return punchin_screen_state();
  }
}

class punchin_screen_state extends State<punchin_screen> {
  var _padding = 12.0;
  bool _value = true;
  ...
  void initState() {
    ...
    setState(() {
      Fluttertoast.showToast(
          msg:
              "Punch In : 9:20 AM \n  Form: 305, Privilege Avenue, Opp. isha hospital, Behind atlantis Sarabhai campus, Sarabhai Rd, Vadiwadi, Vadodara, Gujarat 390023 ",
